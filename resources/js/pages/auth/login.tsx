...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#09090b] px-4 text-white selection:bg-[#ED1C24] selection:text-white">
            ...
            <div className="pointer-events-none absolute top-0 left-1/4 h-96 w-96 rounded-full bg-[#ED1C24]/10 blur-[150px]" />
            <div className="pointer-events-none absolute right-1/4 bottom-0 h-96 w-96 rounded-full bg-white/5 blur-[150px]" />
            ...
            <div className="relative z-10 w-full max-w-md rounded-3xl border border-zinc-800/80 bg-[#121214] p-8 shadow-2xl transition-all duration-300 hover:border-zinc-700/50 md:p-10">
                <div className="mb-8 text-center">
                    ...
                    <h2 className="text-2xl font-black tracking-tight text-white uppercase md:text-3xl">Witaj ponownie</h2>
                    <p className="mt-2 text-xs font-semibold tracking-widest text-zinc-400 uppercase md:text-sm">Zaloguj się na swoje konto</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    <div>
                        ...
                        {errors.email && <p className="mt-1.5 text-xs font-semibold tracking-wider text-red-500 uppercase">{errors.email}</p>}
                    </div>

                    <div>
                        <div className="mb-2 flex items-center justify-between">
                            <label htmlFor="password" className="block text-xs font-bold tracking-widest text-zinc-400 uppercase">
                                Hasło
                            </label>
                            {canResetPassword && (
                                <a
                                    href={route('password.request')}
                                    className="text-xs font-semibold text-[#ED1C24] transition-colors duration-200 hover:text-white"
                                >
                                    Nie pamiętasz hasła?
                                </a>
                            )}
                        ...
                        {errors.password && <p className="mt-1.5 text-xs font-semibold tracking-wider text-red-500 uppercase">{errors.password}</p>}
                    </div>
                    ...
                    <div className="flex items-center">
                        <label className="relative flex cursor-pointer items-center select-none">
                            ...
                            />
                            <div className="flex h-5 w-5 items-center justify-center rounded-md border border-zinc-800 bg-zinc-900 transition-all peer-checked:border-[#ED1C24] peer-checked:bg-[#ED1C24] peer-hover:border-zinc-700">
                                <svg
                            ...
                            <span className="ml-3 text-xs font-bold tracking-widest text-zinc-400 uppercase">Zapamiętaj mnie</span>
                        </label>
                    </div>
                    ...
                    <div className="mt-6 text-center">
                        <span className="text-xs font-bold tracking-widest text-zinc-500 uppercase">Nie masz konta? </span>
                        <a
                            href={route('register')}
